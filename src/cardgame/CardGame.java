...
public class CardGame {
    ...
    public static void main(String[] args) {
        Card[] hand = createRandomHand();
        displayHand(hand);

        try {
            String suitInput = JOptionPane.showInputDialog("Select a card suit (HEARTS, CLUBS, SPADES, DIAMONDS):");
            if (suitInput == null) {
            ...
            String valueInput = JOptionPane.showInputDialog("Select a card value (ACE, TWO, THREE, FOUR, FIVE, SIX, SEVEN, EIGHT, NINE, TEN, JACK, QUEEN, KING):");
            if (valueInput == null) {
            ...
            Card userCard = new Card(selectedValue, selectedSuit);

            boolean isCardInHand = checkCardInHand(hand, userCard);
            if (isCardInHand) {
    ...
    private static Card[] createRandomHand() {
    ...
    private static boolean checkCardInHand(Card[] hand, Card userCard) {
        for (Card card : hand) {
